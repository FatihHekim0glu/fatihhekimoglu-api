...
def ensure_dataframe(
    ...
    *,
    ...
    if isinstance(data, pd.DataFrame):
        ...
        # Curated pandas suppression (see pyproject mypy override): pandas-stubs'
        # DataFrame overloads reject a bare ``object``, but this branch accepts
        # any mapping/sequence coercible to a frame and validates the result
        # below.
