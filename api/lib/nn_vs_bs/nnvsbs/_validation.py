...
def ensure_dataframe(
    ...
    *,
    ...
    if isinstance(data, pd.DataFrame):
        ...
        # Boundary coercion: ``data`` is a loosely-typed mapping/sequence the caller
        # asserts is DataFrame-constructible; ``cast`` to ``Any`` keeps the strict
        # signature while accepting pandas' broad runtime constructor contract.
