...
# quantcore-candidate: mirrors hrp-portfolio:src/hrp/_manifest.py
...
class RunManifest:
    ...
    seed:
        The master RNG seed (feeds :func:`edgar_nlp._rng.make_rng`).
    extra:
        Optional extra provenance (e.g. ``data_source``, ``edgar_acceptance``).
    """
