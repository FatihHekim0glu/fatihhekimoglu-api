...
:data:`edgar_nlp._constants.PERIODS_PER_YEAR`.
...
from edgar_nlp._typing import ReturnsLike
from edgar_nlp._validation import ensure_series
...
def sharpe_ratio(
    ...
    *,
    ...
    """
    from edgar_nlp._constants import EPS
